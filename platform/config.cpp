...
static void loadDefaults()
{
	...
	Settings.Transparency = TRUE; // clort - was false  but droid4 can handle it - n900 maybe too slowk

	Settings.SupportHiRes = FALSE; // clort - setting to true breaks scaling for low res
